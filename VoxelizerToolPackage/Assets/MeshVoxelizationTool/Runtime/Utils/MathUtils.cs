...
namespace Voxelization.Utils
{
    public static class MathUtils
    {
        ...
        public static Vector3Int TranslatePositionToGrid(Vector3 min, Vector3 position, float delimeter)
        {
            var diff = position - min;
            var x = Mathf.RoundToInt(diff.x / delimeter);
            var y = Mathf.RoundToInt(diff.y / delimeter);
            var z = Mathf.RoundToInt(diff.z / delimeter);
